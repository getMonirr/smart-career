        ...
        <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
          <div className="w-full md:w-1/2">
            <div className="mb-10 md:mb-20 text-gray-600 font-light">
              ...
              <p className="font-black uppercase text-3xl lg:text-5xl mb-3">
                {status}
              </p>
              <p>{data}</p>
              <p className="text-yellow-500 text-2xl mt-2">{statusText}</p>
            </div>
            <div className="mb-20 md:mb-0">
              <Link to="/">
                <Button className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-white hover:font-bold">
                  Go Home
                </Button>
              </Link>
            </div>
